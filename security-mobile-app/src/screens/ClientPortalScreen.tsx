...
const styles = StyleSheet.create({
  ...
  portalSubtitle: { color: colors.pending, marginTop: 6, lineHeight: 20 },
  ...
  errorCard: { backgroundColor: colors.dangerSurface, borderWidth: 1, borderColor: colors.dangerSurface, borderRadius: 16, padding: 14 },
