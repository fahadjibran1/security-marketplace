...
const styles = StyleSheet.create({
  ...
  filterLabel: { color: colors.pending, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.4 },
  input: { minHeight: 48, borderRadius: 14, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.card, paddingHorizontal: 14, paddingVertical: 12, color: colors.primaryNavyStrong, minWidth: 180 },
  ...
  bulkCard: { backgroundColor: colors.card, borderRadius: 22, padding: 18, gap: 14 },
  bulkHeader: { flexDirection: 'row', justifyContent: 'space-between', gap: 12, alignItems: 'center', flexWrap: 'wrap' },
  bulkTitle: { color: colors.primaryNavy, fontSize: 18, fontWeight: '800' },
  bulkSubtitle: { color: colors.pending, fontSize: 13, marginTop: 4 },
  bulkActions: { flexDirection: 'row', gap: 10, alignItems: 'center', flexWrap: 'wrap' },
  suggestionRow: { borderTopColor: colors.pendingSurface, borderTopWidth: 1, paddingTop: 12, flexDirection: 'row', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', alignItems: 'center' },
  suggestionCopy: { flex: 1, minWidth: 240 },
  suggestionTitle: { color: colors.primaryNavy, fontWeight: '800' },
  ...
  batchBuilder: { gap: 10, borderTopWidth: 1, borderTopColor: colors.pendingSurface, paddingTop: 14 },
  batchBuilderTitle: { color: colors.primaryNavy, fontSize: 16, fontWeight: '800' },
  batchBuilderCopy: { color: colors.pending, fontSize: 13, lineHeight: 18 },
  ...
  nativeCheckbox: { width: 16, height: 16, borderWidth: 1, borderColor: colors.pending, borderRadius: 4, backgroundColor: colors.card },
  nativeCheckboxChecked: { backgroundColor: colors.primaryNavy, borderColor: colors.primaryNavy },
  ...
  summaryLabel: { color: colors.pending, fontSize: 13, fontWeight: '700' },
  ...
  reviewListCard: { flex: 2.2, minWidth: 880, backgroundColor: colors.card, borderRadius: 22, padding: 18, gap: 14 },
  ...
  rowsHeaderText: { color: colors.pending, fontWeight: '700', fontSize: 12, textTransform: 'uppercase' },
  ...
  disabledSelectText: { color: colors.neutralSlate, fontSize: 11, fontWeight: '700' },
  ...
  detailMetaLabel: { color: colors.pending, fontSize: 12, fontWeight: '700', textTransform: 'uppercase' },
