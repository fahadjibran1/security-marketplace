...
const styles = StyleSheet.create({
  ...
  ruleCard: { borderColor: colors.pendingSurface, borderWidth: 1, borderRadius: 18, padding: 14, gap: 10 },
  ruleHeader: { flexDirection: 'row', justifyContent: 'space-between', gap: 10, alignItems: 'flex-start' },
  ruleTitle: { color: colors.primaryNavy, fontWeight: '800', fontSize: 16 },
  ruleMeta: { color: colors.textSecondary, fontSize: 12, marginTop: 3 },
  statusBadge: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 },
  activeBadge: { backgroundColor: colors.successSurface },
  inactiveBadge: { backgroundColor: colors.pendingSurface },
  statusBadgeText: { color: colors.primaryNavy, fontSize: 12, fontWeight: '800' },
  ruleFacts: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  factText: { color: colors.primaryNavySoft, fontSize: 12, fontWeight: '700', backgroundColor: colors.background, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 },
  ...
  input: { minWidth: 160, flex: 1, backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, color: colors.primaryNavyStrong },
  formRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  notesInput: { minHeight: 80, textAlignVertical: 'top' },
  togglePill: { borderColor: colors.border, borderWidth: 1, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 11 },
  togglePillActive: { backgroundColor: colors.accentTealStrong, borderColor: colors.accentTealStrong },
  togglePillText: { color: colors.primaryNavy, fontWeight: '800' },
  togglePillTextActive: { color: colors.card },
});
