...
const styles = StyleSheet.create({
  ...
  statusValid: { backgroundColor: colors.successSurface, borderColor: colors.successSurface },
  statusExpiring: { backgroundColor: colors.warningSurface, borderColor: colors.warningSurface },
  statusExpired: { backgroundColor: colors.dangerSurface, borderColor: colors.dangerSurface },
  statusInvalid: { backgroundColor: colors.dangerSurface, borderColor: colors.dangerSurface },
