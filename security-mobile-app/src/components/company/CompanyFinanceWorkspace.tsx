...
const styles = StyleSheet.create({
  ...
  errorCard: { backgroundColor: colors.dangerSurface, borderRadius: 18, padding: 16, gap: 4 },
  ...
  metricWarning: { backgroundColor: colors.warningSurface, borderColor: colors.warningSurface },
  metricDanger: { backgroundColor: colors.dangerSurface, borderColor: colors.dangerSurface },
  metricLabel: { color: colors.pending, fontSize: 12, fontWeight: '700', textTransform: 'uppercase' },
  metricValue: { color: colors.primaryNavy, fontSize: 20, fontWeight: '800', marginTop: 8 },
  ...
  monthRow: { borderBottomColor: colors.surfaceSubtle, borderBottomWidth: 1, paddingBottom: 10, marginBottom: 10, flexDirection: 'row', justifyContent: 'space-between', gap: 16 },
  monthMeta: { flex: 1 },
  monthLabel: { color: colors.primaryNavy, fontWeight: '800', fontSize: 15 },
  monthValues: { minWidth: 240, gap: 4 },
  monthValue: { color: colors.primaryNavySoft, fontWeight: '700', textAlign: 'right' },
  bucketRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  bucketCard: { minWidth: 150, flex: 1, backgroundColor: colors.background, borderRadius: 16, padding: 14, borderColor: colors.pendingSurface, borderWidth: 1 },
  bucketDanger: { backgroundColor: colors.dangerSurface, borderColor: colors.dangerSurface },
  table: { minWidth: 980 },
  tableHeader: { flexDirection: 'row', gap: 10, paddingVertical: 10, borderBottomColor: colors.pendingSurface, borderBottomWidth: 1 },
  headerCell: { width: 110, color: colors.pending, fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
  ...
  tableCell: { width: 110, color: colors.primaryNavy, fontWeight: '700', fontSize: 12 },
  invoiceCol: { width: 220 },
  rowTitle: { color: colors.primaryNavy, fontWeight: '800' },
  rowMeta: { color: colors.pending, fontSize: 12, marginTop: 3 },
  reconCard: { borderColor: colors.pendingSurface, borderWidth: 1, borderRadius: 18, padding: 14, gap: 8 },
  detailRow: { borderBottomColor: colors.surfaceSubtle, borderBottomWidth: 1, paddingBottom: 8 },
  detailLabel: { color: colors.pending, fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
  detailValue: { color: colors.primaryNavy, fontSize: 14, fontWeight: '700', marginTop: 3 },
  paymentList: { marginTop: 4, gap: 4 },
  paymentItem: { color: colors.primaryNavySoft, fontSize: 12, fontWeight: '700' },
});
