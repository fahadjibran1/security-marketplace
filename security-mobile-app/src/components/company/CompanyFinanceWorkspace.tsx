...
const styles = StyleSheet.create({
  ...
  bucketDanger: { backgroundColor: colors.dangerSurface, borderColor: colors.dangerBorder },
  table: { minWidth: 980 },
  tableHeader: { flexDirection: 'row', gap: 10, paddingVertical: 10, borderBottomColor: colors.pendingSurface, borderBottomWidth: 1 },
  headerCell: { width: 110, color: colors.textSecondary, fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
