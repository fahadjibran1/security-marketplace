...
const styles = StyleSheet.create({
  ...
  summaryLabel: { color: '#6B7280', fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
  summaryValue: { color: '#111827', fontSize: 16, fontWeight: '800' },
  ...
  primaryButton: { alignSelf: 'flex-start', backgroundColor: '#111827', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12 },
  primaryButtonText: { color: '#FFFFFF', fontWeight: '800' },
  secondaryButton: { alignSelf: 'flex-start', backgroundColor: '#E5E7EB', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12 },
  secondaryButtonText: { color: '#111827', fontWeight: '800' },
  selectWrap: { gap: 8 },
  selectLabel: { color: '#6B7280', fontSize: 12, fontWeight: '800', textTransform: 'uppercase' },
  selectRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  selectPill: { borderWidth: 1, borderColor: '#D1D5DB', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#FFFFFF' },
  selectPillActive: { borderColor: '#111827', backgroundColor: '#111827' },
  selectPillText: { color: '#111827', fontWeight: '700' },
  selectPillTextActive: { color: '#FFFFFF' },
  documentRow: { borderTopWidth: 1, borderTopColor: '#E5E7EB', paddingTop: 10, gap: 8, flexDirection: 'row', alignItems: 'flex-start' },
  documentTitle: { color: '#111827', fontWeight: '800', textTransform: 'capitalize' },
